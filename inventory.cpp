...
class Inventory
{
    ...
    void addProduct(product product)
    {
        ...
        void saveInventoryToFile(string electronics) 
        {
            ofstream file;
            file.open(electronics, ios::out | ios::app);
    ...
    void loadInventoryFromFile(string electronics) 
    {
        ifstream file;
        file.open(electronics);
        ...
        if (file.is_open()) 
        {
            ...
            cout << "Error: Could not open file " << electronics << endl;
        }
    }
};
...
int main()
{
    ...
    do {
        ...
        case '6': {
            inventory.saveInventoryToFile("electronics.csv");
            cout << "Inventory saved to file." << endl;
            cout << "-----------------------------------------------------------" <<endl;
            break;
        }
        case '7': {
            inventory.loadInventoryFromFile("electronics.csv");
